...
public class QuickSortTest {
    ...
    public static void main (String [] args) {
        ...
        System.out.println("*** This program sorts an array of random integers between -5000 to 5000 by using Quicksort algorithm.");
        ...
        System.out.println();
        System.out.println("*** QuickSort Test 1: Small size array. There are 25 integers in the array.");

        if (isSorted(smallArray)) {
            System.out.println("QuickSort on small size array SUCCESSFULLY performed.");
        } else {
            System.out.println("QuickSort on small size array FAILED.");
        }
        ...
        sort.QuickSort(MediumArray, 0, MediumArray.length - 1);
        // after QuickSort
        // System.out.println(Arrays.toString(MediumArray));
        
        System.out.println();
        System.out.println("*** QuickSort Test 2: Medium size array. There are 500 integers in the array.");

        if (isSorted(MediumArray)) {
            System.out.println("QuickSort on medium size array SUCCESSFULLY performed.");
        } else {
            System.out.println("QuickSort on medium size array FAILED.");
        }
        ...
        sort.QuickSort(bigArray, 0, bigArray.length - 1);
        // after QuickSort
        // System.out.println(Arrays.toString(bigArray));

        System.out.println();
        System.out.println("*** QuickSort Test 3: Big size array. There are 10,000 integers in the array.");

        if (isSorted(bigArray)) {
            System.out.println("QuickSort on big size array SUCCESSFULLY performed.");
        } else {
            System.out.println("QuickSort on big size array FAILED.");
        }
